...
describe("About Higher Order Functions", function() {
  ...
  it("should use range to generate an array", function() { //this is more about learning underscore.js
    expect(_.range(3)).toEqual([0, 1, 2]);
    expect(_.range(1, 4)).toEqual([1, 2, 3]);
    expect(_.range(0, -4, -1)).toEqual([0, -1, -2, -3]);
  });

  it("should use flatten to make nested arrays easy to work with", function() { //this is more about learning underscore.js
    expect(_([
      [1, 2],
      [3, 4]
  ...
  it("should use chain() ... .value() to use multiple higher order functions", function() { //this is more about learning underscore.js
    var result = _([
        [0, 1], 2
      ]).chain()
      .flatten()
